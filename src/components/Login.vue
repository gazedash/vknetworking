    ...
    <div class="root">
      <mu-paper class="paper" :zDepth="1">
        ...
        <div class="form">
          ...
          <mu-raised-button class="button" backgroundColor="#507299" @click="login" type="submit">
            <div class="content" slot="default">
              <svg xmlns:xlink="http://www.w3.org/1999/xlink" class="logo" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" width="32px" height="32px" viewBox="0 0 548.358 548.358" style="enable-background:new 0 0 548.358 548.358;" xml:space="preserve">
...
<script>
  ...
  import { windowClosedPromise, createSignInPopup, createPopup, redirectToGetToken } from "../utils/index";
  import { LOGIN_ERROR } from "../const/index";
  import AppHeader from "./AppHeader";
  import { buildVkAuthUrl, client_id, redirect_uri } from "../vk_api/index";
