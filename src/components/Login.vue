        ...
        <div class="form">
          ...
          <mu-raised-button class="button" backgroundColor="#507299" @click="login" type="submit">
            <div class="content" slot="default">
              <svg class="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="32px" height="32px" viewBox="0 0 548.358 548.358" style="enable-background:new 0 0 548.358 548.358;" xml:space="preserve">
